...
class DialogAddAuthor extends Component {
    ...
    submit() {
        ...
        APIManager.post('/mysql/addauthor', {
                ...
                <Modal
                    ...
                    <Modal.Body>
                        ...
                        <div>
                            ...
                            <div className="form-group">
                                <input type="text" className="form-control" name="language" placeholder="Language" />
                            </div>
                            <div className="form-group">
                                <input type="text" className="form-control" name="publicationDate" placeholder="Publication Date" />
                            </div>
                            <div className="form-group">
                                <input type="text" className="form-control" name="store" placeholder="Store" />
                            </div>*/}
